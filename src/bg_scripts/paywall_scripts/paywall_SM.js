// paywall_SM.js contains all the functionality for the paywall blacklist for changing referer to be from Social Media site
...
function addToPaywallSMWhitelist(root) {
  chrome.storage.sync.get(['paywallSMWhitelistDict'], result => {
